...
def weighted_l1_loss():
    '''Computes L1 loss, using the last channel of y_true as normalization weights
...
def weighted_binary_crossentropy(from_logits=False):
    '''Computes binary cross-entropy loss, using the last channel of y_true  as normalization weights
